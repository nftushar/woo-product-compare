...
Tags: product-compare, product, woocommerce 
...
**[Demos](https://bblockswp.com/demo/product-compare/)**
...
= How to use =
- First, install the product-compare plugin
- Add the product-compare block from the block category called "Widgets" in the Gutenberg editor.
...
2. Search For **product-compare**
3. Click on the **product-compare** to add the block

= Download & Upload: =
1. Download the **product-compare** plugin (*.zip file*)
2. In your admin area, go to the Plugins menu and click on **Add New**
3. Click on **Upload Plugin** and choose the **`product-compare.zip`** file and click on **Install Now**
4. Activate the plugin and Enjoy!

= Manually: =
1. Download and upload the **product-compare** plugin to the **`/wp-content/plugins/`** directory
2. Activate the plugin through the Plugins menu in WordPress


== Frequently Asked Questions ==

= Is product-compare free? =

Yes, product-compare is a free Gutenberg block plugin.
...
You can post your questions on the [support forum here](https://wordpress.org/support/plugin/product-compare/)
